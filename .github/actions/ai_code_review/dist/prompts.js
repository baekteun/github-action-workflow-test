...
class Prompts {
    constructor(summarize = "", summarizeReleaseNotes = "") {
        this.summarizeFileDiff = `## GitHub PR Title
...
`;
        this.triageFileDiff = `Below the summary, I would also like you to triage the diff as \`NEEDS_REVIEW\` or 
...
`;
        this.summarizeChangesets = `Provided below are changesets in this pull request. Changesets 
...
$raw_summary
`;
        this.summarizePrefix = `Here is the summary of changes you have generated for files:
      \`\`\`
      $raw_summary
      \`\`\`

`;
        this.summarizeShort = `Your task is to provide a concise summary of the changes. This 
...
`;
        this.reviewFileDiff = `## GitHub PR Title
...
$patches
`;
        this.comment = `A comment was made on a GitHub PR review for a 
