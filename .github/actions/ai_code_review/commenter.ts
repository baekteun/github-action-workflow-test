...
export const COMMENT_GREETING = `${getInput("bot_icon")}   AI Code Reviewer`;

export const COMMENT_TAG =
  "<!-- This is an auto-generated comment by AI Code Reviewer -->";

export const COMMENT_REPLY_TAG =
  "<!-- This is an auto-generated reply by AI Code Reviewer -->";

export const SUMMARIZE_TAG =
  "<!-- This is an auto-generated comment: summarize by AI Code Reviewer -->";

export const IN_PROGRESS_START_TAG =
  "<!-- This is an auto-generated comment: summarize review in progress by AI Code Reviewer -->";

export const IN_PROGRESS_END_TAG =
  "<!-- end of auto-generated comment: summarize review in progress by AI Code Reviewer -->";

export const DESCRIPTION_START_TAG =
  "<!-- This is an auto-generated comment: release notes by AI Code Reviewer -->";
export const DESCRIPTION_END_TAG =
  "<!-- end of auto-generated comment: release notes by AI Code Reviewer -->";

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by AI Code Reviewer -->
<!--
`;
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by AI Code Reviewer -->`;

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by AI Code Reviewer -->
<!--
`;
